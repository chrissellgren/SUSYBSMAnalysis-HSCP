...
config.Data.outLFNDirBase = '/store/user/csellgre ./HSCP'
config.Data.ignoreLocality = True
config.Data.partialDataset = False 
config.Data.publication = False

config.section_('Site')
config.Site.whitelist = ['T2_DE_DESY','T2_CH_CERN','T2_IT_Bari','T1_IT_*','T2_US_*', 'T3_US_FNALLPC','T3_CH_CERNBOX .','T2_FR_*', 'T2_UK_London_IC']
...
def task(i):
  ...
  shortSampleName = i[1:(i.find('-'))].replace("/","_")+EVAD if ("SingleMuon" in i) else  i[1:(i.find('TuneCP5'))].replace("/","_")+EVAD
